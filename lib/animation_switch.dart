part of switcher_xlive;

class _SwitcherXliveRenderObjectWidget extends LeafRenderObjectWidget {
  const _SwitcherXliveRenderObjectWidget({
    Key? key,
    this.value,
    this.activeColor,
    this.unActiveColor,
...
class _RenderXliveSwitch extends RenderConstrainedBox {
  ...
  final _SwitcherXliveThumbPainter _thumbPainter;
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    final double thumbLeft = lerpDouble(
      trackRect.left + _kTrackInnerStart - _SwitcherXliveThumbPainter.radius,
      trackRect.left + _kTrackInnerEnd - _SwitcherXliveThumbPainter.radius,
      visualPosition,
    )!;
    ...
    _thumbPainter.paint(
      ...
      Rect.fromLTRB(
        ...
        thumbCenterY - _SwitcherXliveThumbPainter.radius,
