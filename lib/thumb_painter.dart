...
class _SwitcherXliveThumbPainter {
  _SwitcherXliveThumbPainter({
   required  this.color,
  ...
  void paint(Canvas canvas, Rect rect) {
    ...
    canvas.drawDRRect(rrectParent.shift(const Offset(0.0, 3.0)), childRect.shift(const Offset(0.0, 3.0)), _shadowPaint);
    canvas.drawDRRect(
        RRect.fromLTRBR(
          rrectParent.left,
          rrectParent.top,
